...
/*
 * For lighthouse files move all start navigation events to beignning of messages array.
 */
function reorder(messages) {
  ...
  for (const message of messages) {
      ...
      reorderedMessages[action](message);
  }
        ...
        case 'Network.dataReceived':
          {
            ...
            if (!entry.response) {
              throw new Error(
                  `Were these messages generated by lighthouse? If so specify '--lighthouse' and try again.
Otherwise this file invalid.`);
            }
